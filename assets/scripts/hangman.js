...
function gameOver() {
    ...
    // Logging player actions to the logPlayerActionsAll array
    logPlayerActions();
...
function playerActionsTable() { //create table to show player actions need
    // to create loops to put out game actions log to a table
}